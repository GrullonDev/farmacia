    ...
    <div class="modal-dialog" role="document">
      ...
      <div id="resultados_ajax"></div>
        ...
        <input  type="button" class="btn btn-success"  id="btn-ingresar" value="Buscar <?php echo PJ;?>/<?php echo PN;?> " />
				...
				<div class="form-group">
				<label for="doc" class="col-sm-3 control-label">Numero de Nit</label>
				<div class="col-md-8 col-sm-8 col-xs-12">
				<input type="number" min="1" autocomplete="off" class="form-control"  id="doc" name="doc" placeholder="Nro de Nit" >
				</div>
			  </div>
			...
			<div class="form-group">
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
					<input type="text" class="form-control" id="provincia" name="provincia" placeholder="Provincia">
                        ...
                        <div class="form-group">
				<label for="distrito" class="col-sm-3 control-label">Zona</label>
				<div class="col-md-8 col-sm-8 col-xs-12">
