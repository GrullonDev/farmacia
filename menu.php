...
function menu1()
{
  ...
  <div class="profile" style="text-align: center;">
    ...
    <img src="img/man_default.svg" width="30%" height="30%" class="img-circle"><br><span>SUNAT</span><br>
    <h6><?php echo $name; ?></h6>
...
function menu3()
{
  ...
  <div class="top_nav">
    ...
    <div class="nav_menu" style="background-color:  #001394;">
      <div class="nav toggle" style="width:23%"><a id="menu_toggle"><i style="color: #FFFFFF" class="fa fa-bars"></i></a>
      </div>
      <?php
      ...
      <ul class="navbar-right">
        ...
        <li class="panel-heading">
          ...
          <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown"
            ...
            <img src="img/man_default.svg" alt="">
            <font style="color: #FFFFFF"><?php echo $name ?></font><span style="color: #FFFFFF; font-size: 20px;"
          ...
          <ul class="dropdown-menu dropdown-menu-right">
            ...
            ?>
            <li><a href="perfil_user.php"><i class="icon-user-plus color-indigo"></i><i
        ...
        <li class="panel-heading">
          <div class="btn-group">
            <button class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title=""
              data-original-title="Caja" onclick="window.location.href='caja.php'"><i class="fa fa-dollar"></i></button>
            <button class="btn btn-warning" data-toggle="tooltip" data-placement="bottom" title=""
              data-original-title="Lista de ventas" onclick="window.location.href='facturas.php'"><span
                class="glyphicon glyphicon-list-alt" aria-hidden="true"></span></button>
            <button class="btn btn-danger" data-toggle="tooltip" data-placement="bottom" title=""
              data-original-title="Facturación" onclick="window.location.href='nueva_factura.php'"><span
                class="glyphicon glyphicon-indent-right" aria-hidden="true"></span></button>
