  ...
  <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    ...
    <div class="menu_section">
      ...
      <ul class="nav side-menu">
        ...
        <li><a href="facturaseliminadas.php">
            <font color=red><strong>Ventas Eliminadas</strong></font>
          </a>

        </li>

        <li><a href="facturaelectronica.php"><img src="ajax/sunat.png" width="25" height="25">
            <font color=blue>Facturación Electrónica</font>
          </a>
      ...
      <nav class="" role="navigation">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li role="presentation" class="dropdown">
            <a href="http://localhost:82/Nueva%20carpeta/tienda1/" target="_blanck"
              title="Pagina Web y Carrito de Compras">
