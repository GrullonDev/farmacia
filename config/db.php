...
//define('DB_USER', 'u699417110_farmacia');//Usuario de tu base de datos
define('DB_USER', 'u417850534_farmacia_depaz');//Usuario de tu base de datos
//define('DB_PASS', 'Alaimes7.');//Contraseña del usuario de la base de datos
define('DB_PASS', 'PALABRAS*19elegantes');//Contraseña del usuario de la base de datos
//define('DB_NAME', 'u699417110_farmacia');//Nombre de la base de datos
define('DB_NAME', 'u417850534_farmacia_depaz');//Nombre de la base de datos
