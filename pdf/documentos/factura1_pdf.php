...
$insert = mysqli_query($con, "
  INSERT INTO facturas (
    numero_factura, fecha_factura, cod_hash, doc_mod, id_cliente, baja,
    id_vendedor, condiciones, total_venta, deuda_total, estado_factura,
    tienda, ven_com, activo, servicio, moneda, nombre, obs, cuenta1,
    fec_eli, dias, folio, des, aceptado, resumen, motivo, tipo
  ) VALUES (
    '$numero_factura', '$date', '0', '', '$id_proveedores', '0',
    '$id_vendedor', '$condiciones', '$sumador_total', '$deuda', '$tipo',
    '$c', '2', '1', '0', '$moneda1', '$cuenta', '$obs', '0',
    '2018-11-11', '$dias', '$folio', '2', '', '0', '', '0'
  )
");
